...
module.exports = {
  ...
  safelist: [
    ...
    'flex-wrap',
    'float-left',
    'font-bold', 'font-extrabold', 'font-normal', 'font-semibold',
    ...
    'h-16', 'h-390', 'h-[390px]', 'h-auto', 'h-fit', 'h-full',
    'hidden',
    ...
    'lg--grid-cols-6',
    'list-none',
    'm-0', 'm-2', 'mb-0', 'mb-2', 'mb-3', 'mb-5', 'mb-6', 'mb-10', 'me-2', 'me-3', 'me-4', 'me-10', 'ml-0', 'ms-0', 'ms-4', 'ms-auto', 'mt-0', 'mt-4', 'mt-10', 'mt-[3px]', 'mx-0.5', 'mx-2', 'mx-5', 'mx-10', 'my-5',
    'max-w-[240px]',
    ...
    'sm--grid-cols-2',
    'sticky',
    'text-lg', 'text-2xl', 'text-5xl', 'text-[32px]', 'text-center', 'text-dark-teal', 'text-orange', 'text-white', 'text-white-er',
    'top-0',
    'w-6', 'w-9', 'w-20', 'w-24', 'w-40', 'w-60', 'w-72', 'w-80','w-96','w-[90%]', 'w-auto', 'w-fit', 'w-full',
