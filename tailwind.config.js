...
module.exports = {
  ...
  safelist: [
    ...
    'lg--grid-cols-6',
    'list-none',
    'm-0', 'm-2', 'mb-0', 'mb-2', 'mb-3', 'mb-5', 'mb-6', 'mb-10', 'me-2', 'me-3', 'me-4', 'me-10', 'ms-0', 'ms-4', 'ms-auto', 'mt-0', 'mt-4', 'mt-[3px]', 'mx-0.5', 'mx-2', 'mx-5', 'my-5',
    'max-w-[240px]',
    'md--w-1/3', 'md--grid-cols-2', 'md--grid-cols-3', 'md--grid-cols-4', 'md--grid-cols-10', 'md--col-span-3', 'md--col-span-4',
    'no-underline',
    'object-contain',
    'open:bg-white',
    'p-2', 'p-3', 'p-4', 'p-5', 'p-10','pb-4', 'pb-5', 'ps-0', 'ps-2.5', 'ps-5', 'pe-2.5', 'pe-10', 'pt-4', 'px-1.5', 'px-2.5', 'px-4', 'px-5', 'px-50%', 'py-0.5', 'py-2', 'py-3', 'py-4', 'py-10', 'py-14',
    'relative',
    'row-span-2',
    'shrink-0',
    'sm--grid-cols-2',
    ...
    'text-sm',
    'top-0',
    'w-6', 'w-9', 'w-24', 'w-40', 'w-[90%]', 'w-auto', 'w-fit', 'w-full',
