...
module.exports = {
  ...
  safelist: [
    ...
    'lg--grid-cols-6',
    'list-none',
    'm-0', 'm-2', 'mb-2', 'mb-3', 'mb-5', 'mb-6', 'mb-10', 'me-2', 'me-3', 'me-4', 'me-10', 'ms-0', 'ms-4', 'ms-auto', 'mt-0', 'mt-4', 'mt-12', 'mt-[3px]', 'md--mt-16', 'mx-0.5', 'mx-2', 'mx-5', 'my-5',
    'max-w-[240px]',
    'md--w-1/3', 'md--grid-cols-2', 'md--grid-cols-3', 'md--grid-cols-4', 'md--col-span-3',
    'no-underline',
    'object-contain',
    'open:bg-white',
    'p-1', 'p-2', 'p-3','p-4', 'p-5', 'p-10', 'ps-0', 'ps-2.5', 'ps-5', 'pe-2.5', 'pe-10', 'px-1.5', 'px-2.5', 'px-5', 'px-50%', 'py-0.5', 'py-2', 'py-3', 'py-4', 'py-5', 'py-10', 'py-14',
    'relative',
    'row-span-2',
    'shrink-0',
    'sm--grid-cols-2',
