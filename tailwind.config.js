...
module.exports = {
  ...
  safelist: [
    ...
    'lg--grid-cols-6',
    'list-none',
    'm-0', 'm-1', 'm-2', 'mb-0', 'mb-1', 'mb-2', 'mb-3', 'mb-5', 'mb-10', 'me-2', 'me-3', 'me-4', 'me-10', 'ms-0', 'ms-4', 'ms-auto', 'ms-5', 'mt-0', 'mt-4', 'mt-[3px]', 'mx-0.5', 'mx-1', 'mx-2', 'mx-5', 'my-5', 'my-10',
    'max-w-[240px]', 'max-w-100',
    'md--block', 'md--pe-10',
    'md--grid-cols-2', 'md--grid-cols-3', 'md--grid-cols-4', 'md--grid-cols-10', 'md--col-span-3', 'md--col-span-4', 'md--pb-0', 'md--pt-0', 'md--w-1/5', 'md--w-1/2',
    'no-underline',
    'object-contain',
    'open:bg-white',
    'p-2', 'p-3', 'p-4', 'p-5', 'p-10', 'pb-4', 'pb-10', 'pb-32', 'ps-0', 'ps-2.5', 'ps-5', 'pe-2.5', 'pe-10', 'pt-4', 'pt-10', 'pt-24',
    ...
    'top-0', 'top-10',
    'w-6', 'w-9', 'w-24', 'w-40', 'w-56', 'w-96', 'w-2/5', 'w-[494px]', 'w-[90%]', 'w-auto', 'w-fit', 'w-full', 'w-max',
