...
module.exports = {
  ...
  safelist: [
    ...
    'no-underline',
    'open:bg-white',
    'p-2', 'pt-2', 'p-3','p-4', 'p-5', 'p-10', 'ps-0', 'ps-2.5', 'ps-5', 'pe-2.5', 'pe-10', 'px-1.5', 'px-2.5', 'px-5', 'px-16', 'px-50%', 'py-0.5', 'py-2', 'py-3', 'py-4', 'py-5', 'py-10', 'py-14',
    'relative',
    'row-span-2',
    'shrink-0',
    'sm--grid-cols-2',
