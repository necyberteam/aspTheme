...
module.exports = {
  ...
  safelist: [
    ...
    'border', 'border-0', 'border', 'border-4', 'border-b', 'border-b-2', 'border-dark-teal',
    'border-4',
    'border-orange',
    'border-x-0',
    'border-t-0',
    ...
    'h-16', 'h-390', 'h-[390px]', 'h-auto', 'h-fit',
    'block', 'md--block',
    'hidden', 'md--hidden',
    ...
    'lg--grid-cols-6',
    'list-none',
    'm-0', 'm-1', 'm-2', 'mb-0', 'mb-1', 'mb-2', 'mb-3', 'mb-5', 'mb-6', 'mb-10', 'me-2', 'me-3', 'me-4', 'me-10', 'ms-0', 'ms-4', 'ms-auto', 'mt-0', 'mt-4', 'mt-12', 'mt-[3px]', 'md--mt-16', 'mx-0.5', 'mx-1', 'mx-2', 'mx-5', 'my-5',
    'max-w-[240px]',
    'md--w-1/3', 'md--grid-cols-2', 'md--grid-cols-3', 'md--grid-cols-4', 'md--col-span-3',
    ...
    'object-contain',
    'open:bg-white',
    'p-1', 'p-2', 'p-3','p-4', 'p-5', 'p-10', 'pb-4', 'ps-0', 'ps-2.5', 'ps-5', 'pe-2.5', 'pe-10', 'pt-4', 'pt-10', 'px-1.5', 'px-2.5', 'px-5', 'px-50%', 'py-0.5', 'py-2', 'py-3', 'py-4', 'py-5', 'py-10', 'py-14',
    ...
    'sm--grid-cols-2',
    'sticky',
    'text-lg', 'text-xl', 'text-2xl', 'text-[32px]', 'text-center', 'text-dark-teal', 'text-white', 'text-white-er',
    'drop-shadow-md',
    'top-0',
    'top-1/4',
    'inset-x-1/4',
    'w-6', 'w-9', 'w-24', 'w-40', 'w-[90%]', 'w-fit', 'w-full',
    'text-sm', 'text-lg', 'text-xl', 'text-2xl', 'text-5xl', 'text-[32px]', 'text-center', 'text-dark-teal', 'text-orange', 'text-white', 'text-white-er',
    'top-0', 'top-10',
