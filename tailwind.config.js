...
module.exports = {
  ...
  safelist: [
    ...
    'border-0', 'border', 'border-4', 'border-dark-teal', 'border-orange',
    'col-1', 'col-2', 'col-span-2', 'col-span-3',
    'cursor-pointer',
    'duration-300',
    'first-of-type--ms-0',
    'font-extrabold', 'font-semibold', 'font-normal', 'font-bold',
    'gap-5', 'gap-10', 'gap-x-10', 'gap-y-5',
    ...
    'h-16', 'h-390', 'h-[390px]', 'h-fit', 'h-full',
    'hidden',
    ...
    'lg--grid-cols-6',
    'list-none',
    'm-2', 'mb-0', 'mb-2', 'mb-5', 'mb-10', 'me-2', 'me-3', 'me-4', 'ms-0', 'ms-4', 'ms-auto', 'mt-[3px]', 'mx-5', 'my-5',
    'max-w-[240px]',
    ...
    'sm--grid-cols-2',
    'sticky',
    'text-lg', 'text-2xl', 'text-5xl',  'text-[32px]', 'text-center', 'text-dark-teal', 'text-white', 'text-orange',
    'top-0',
    'w-auto', 'w-6', 'w-9', 'w-24', 'w-40', 'w-[90%]', 'w-full',
